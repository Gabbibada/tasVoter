                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                ...
                                                                <ul class="panel-tools pull-right">                                                                                                                                        
                                                                    ...
                                                                    <a href="candidate_position.php" class="btn btn-default">Position</a>
                                                                </ul> 
                                                            </div>   
                                                                    ...
                                                                    <table class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="font-size: 30px;">
                                                                                ...
                                                                                <td>2,980</td>
                                                                                <td>1,098</td>
                                                                                <td style="font-weight: bold">1,250</td>                                                                                
                                                                            </tr>
                                                                            <tr style="font-size: 30px;">
                                                                                <td class="text-primary" style="font-weight: bold">Coolchi</td>
                                                                                <td>1,920</td>
                                                                                <td>1,039</td>
                                                                                <td>3,559</td>
                                                                                <td>2,344</td>
                                                                                <td style="font-weight: bold">2,323</td>
                                                                            </tr>
                                                                            <tr style="font-size: 30px;">
                                                                                <td class="text-info" style="font-weight: bold">Mys</td>
                                                                                <td>2,120</td>
                                                                                <td>1,232</td>
                                                                                <td>3,444</td>
                                                                                <td>4,332</td>
                                                                                <td style="font-weight: bold">2,003</td>
                                                                            </tr>
                                                                            <tr style="font-size: 30px;">
                                                                                <td style="font-weight: bold">Gabbi</td>
                                                                                <td>2,150</td>
                                                                                <td>1,233</td>
                                                                                <td>3,223</td>
                                                                                <td>1,232</td>
                                                                                <td style="font-weight: bold;">2,432</td>
                                                                            </tr>
                                                                            <tr style="font-size: 30px;">
                                                                                ...
                                                                                <td style="font-weight: bold;">2,003</td>
                                                                                <td style="font-weight: bold;">2,432</td>
                                                                                <td style="font-weight: bolder;">10,100 </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
