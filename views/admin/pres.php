                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <h3 class="panel-title">
                                                                    <i class="ion ion-android-sort"></i> Presidential Flow
                                                                </h3>
                                                                    ...
                                                                    <table class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="font-size: 30px;">
                                                                                <td class="text-danger" style="font-weight: bold">Sulex D</td>
                                                                                <td>2,920</td>
                                                                                <td>3,120</td>
                                                                                <td>2,980</td>
                                                                                <td>1,098</td>
                                                                                <td style="font-weight: bold;
                                                                                    background: #E98582;
                                                                                    ">10,239
                                                                                    <i style="color: green; font-weight: bolder;font-size: 20px;" class="pull-right fa fa-check"></i>
                                                                                </td>
                                                                            </tr>
                                                                            <tr style="font-size: 30px;">
