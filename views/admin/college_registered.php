                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <h3 class="panel-title">
                                                                    <i class="ion ion-android-sort"></i> College / Level View
                                                                </h3>
                                                                <ul class="panel-tools pull-right">
                                                                    <a style="margin-right: 10px;" href="college_voted.php" class="btn btn-default">Voted</a>
                                                                    <a href="College_registered.php" class="btn btn-default active">Registered</a>
                                                                </ul>                                                                
                                                            </div>   
                                                            <div class="panel-body">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="font-size: 30px;">
                                                                                <td class="text-danger" style="font-weight: bold">COSIT</td>
                                                                                <td>2,920</td>
                                                                                <td>3,120</td>
                                                                                <td>2,980</td>
                                                                                <td>1,098</td>
                                                                            ...
                                                                            <tr style="font-size: 30px;">
                                                                                <td class="text-primary" style="font-weight: bold">COHUM</td>
                                                                                <td>1,920</td>
                                                                                <td>1,039</td>
                                                                                <td>3,559</td>
                                                                                <td>2,344</td>
                                                                            ...
                                                                            <tr style="font-size: 30px;">
                                                                                <td class="text-info" style="font-weight: bold">COAEVOT</td>
                                                                                <td>2,120</td>
                                                                                <td>1,232</td>
                                                                                <td>3,444</td>
                                                                                <td>4,332</td>
                                                                            ...
                                                                            <tr style="font-size: 30px;">
                                                                                <td style="font-weight: bold; color: #f0ad4e;">COSMAS</td>
                                                                                <td>2,150</td>
                                                                                <td>1,233</td>
                                                                                <td>3,223</td>
                                                                                <td>1,232</td>
